...
Client Input & Player Forename       & Max           & Player Database \\ \hline
Client Input & Player Surname        & Smith         & Player Database \\ \hline
Client Input & Player Rating         & 9             & Player Database \\ \hline
Client Input & Player Contact Number & Msmith@gmail.com & Player Database \\ \hline
Client Input & Player Position       & CM            & Player Database \\ \hline
Client Input & Player Availability   & Yes           & Player Database \\ \hline
\end{tabular}
\end{table}
...
Player(PlayerID,PlayerForename,PlayerSurname,PlayerRating,PlayerContact,PlayerPosition)
Match(MatchID,MatchDate,MatchScore)
Goals(MatchID,PlayerID,Quantity)
